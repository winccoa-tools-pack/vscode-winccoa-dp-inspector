 ...
 */
export const EXTENSION_ID = 'winccoa-tools-pack.winccoa-dp-inspector';
 ...
 */
export const EXTENSION_NAME = 'WinCC OA DP Inspector';
 ...
 */
export const EXTENSION_CONFIG_SECTION = 'winccoa.dpInspector';
